...
public class AddGithubOrganization extends CommonDvcsConfigurationAction
{
    ...
    {
        triggerAddStartedEvent(DvcsType.GITHUB);
    ...
    private String doAddOrganization(String accessToken)
    {
        ...
        smartCommitsAnalyticsService.fireNewOrganizationAddedWithSmartCommits(DvcsType.GITHUB, hadAutoSmartCommitsChecked());
        triggerAddSucceededEvent(DvcsType.GITHUB);
    ...
    {
        super.triggerAddFailedEvent(DvcsType.GITHUB, reason);
    }
}
