...
public interface OrganizationService
{
    ...
    /**
     * check if account exists on given server using all available
     * communicators.
     * 
     * @param hostUrl
     *            server host name
     * @param accountName
     *            name of account (organizationName)
     * @return accoutnInfo
     */
    AccountInfo getAccountInfo(String hostUrl, String accountName);

    /**
     * check if account exists on given server using communicator of given
     * <code>dvcsType</code>.
     * 
     * @param hostUrl
     *            server host name
    ...
    /**
     * save Organization to storage. If it's new object (without ID) after this
    ...
    Organization saveAsync(Organization organization);
    ...
    /**
     * @param organization
     * @return returns {@link Group}-s available for provided
     *         {@link Organization}
     */
