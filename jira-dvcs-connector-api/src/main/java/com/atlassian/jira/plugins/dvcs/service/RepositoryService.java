...
/**
 * Returning type {@link Repository} is enriched with synchronization status by
 * default.
 * 
 * 
 * @see SyncProgress
...
public interface RepositoryService
{
     ...
     *            whether to include also deleted repositories
     * @return repositories
     */
    ...
    /**
     * Same as {@link #getAllRepositories()}, but provides choice to include
     * also deleted repositories.
     * 
     * @param includeDeleted
    ...
    /**
     * save Repository to storage. If it's new object (without ID) after this
     * operation it will have it assigned.
     * 
     * @param repository
     *            Repository
     * @return Repository
    ...
    /**
     * Synchronization of repository list in given organization Retrieves list
     * of repositories for organization and adds/removes local repositories
     * accordingly. If autolinking is set to to true new repositories will be
     * linked and they will start synchronizing.
     * 
    ...
    void syncRepositoryListAsync(Organization organization, boolean soft);
    ...
    /**
     * The same as {@link #removeOrphanRepositories()}, but it will run in
     * background.
     * 
     * @param orphanRepositories
     *            to removes
     */
